  ...
  return (
    <main className="min-h-screen bg-[#0b0f19] text-slate-100 font-sansSelection selection:bg-indigo-500/30">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/50 border border-slate-800/80 rounded-2xl px-6 py-5">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-2 max-w-md">
              {user
                ? "Your agent crew is ready — start a new trip conversation or jump back into one."
                : "Sign up to start planning a trip with your own crew of AI travel agents."}
            </p>
          </div>
          <div className="flex items-center gap-3 shrink-0">
            ...
            {!isAuthLoading && (
              <Link
                ...
                className="px-5 py-2.5 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 font-medium text-sm text-white rounded-xl shadow-lg shadow-indigo-500/25 transition-all whitespace-nowrap"
              >
