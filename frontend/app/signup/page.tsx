...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (!isMockMode && password !== confirmPassword) {
  ...
  return (
    <main className="min-h-screen bg-[#0b0f19] text-slate-100 font-sans flex items-center justify-center relative px-6 overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-slate-400">Join the autonomous multi-agent travel suite</p>
        </div>
        ...
        <div className="bg-slate-900/50 border border-slate-800/80 rounded-3xl p-8 backdrop-blur-md shadow-2xl shadow-indigo-950/10 space-y-6">
            ...
            <div className="bg-indigo-950/30 border border-indigo-500/20 rounded-2xl p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400 mt-1 leading-relaxed">
                  Enter any email to create a mock account instantly.
                </p>
              </div>
            </div>
          )}
          ...
          {/* Error Banner */}
          {errorMsg && (
            <div className="bg-red-950/30 border border-red-500/30 text-red-200 rounded-2xl p-4 flex items-center gap-3 text-xs animate-shake">
